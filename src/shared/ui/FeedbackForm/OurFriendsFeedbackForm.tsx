...
interface type {
  title: string
  description: string
  translationKey?: string // Ключ для поиска переводов, по умолчанию 'contacts.feedbackForm'
  recipientEmail?: string // Email получателя письма
}

const OurFriendsFeedbackForm = ({ title, description, translationKey = 'contacts.feedbackForm', recipientEmail }: type) => {
  ...
  const protectedSendFeedback = usePreventDoubleSubmit(
    () => sendFeedback(recipientEmail), 
    2000
  );
...
export default OurFriendsFeedbackForm
